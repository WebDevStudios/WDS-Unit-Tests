The YourPlugin Test Suite uses PHPUnit to help us maintain the best possible code quality.
...
### 2. Initialize local testing environment
...
Change to the YourPlugin directory:
```bash
